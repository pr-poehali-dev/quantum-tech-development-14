        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <p className="font-mono text-xs text-foreground/60 md:text-base">/ Свяжитесь с Fox Coffee</p>
            </div>

            <div className="space-y-4 md:space-y-8">
              <a
                href="mailto:hello@foxcoffee.ru"
              ...
              >
                ...
                <p className="text-base text-foreground md:text-2xl">Ваш город, Россия</p>
              </div>
              ...
              >
                {["Telegram", "VK", "Instagram", "TikTok"].map((social) => (
                  <a
                    key={social}
                    href="#"
